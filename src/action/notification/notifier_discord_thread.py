...
class DiscordNotifierThread(CommonDiscordNotifier):
    ...
    def _notify(self, user_group: UserGroup, medias: list[Media], user_group_status: Optional[UserGroupStatus], header_function: Callable[[str], str], subject_function: Callable[[str], str]):
        ...
        media_texts = ["* " + self._get_markdown_body(locale, media, user_group_status) for media in medias]
